...
| `coordination_hist` | `structure.coordination_hist` | MVP | `pymatviz` | `CoordinationHistAdapter` | periodic `Structure[]` | `plotly_json`、`plotly_html`、`preview_png`、`summary_md`、`recipe_json` | `structure` | 是 | MVP 的局部环境基础图 |
