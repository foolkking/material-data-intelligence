# ward_ptable_heatmap platform result summary
...
- params: `{"formulaColumn": "composition", "countMode": "occurrence", "log": false}`
- rowCount: 8415

## 5. Artifacts
- plotly_json: `sample_artifacts/ptable_heatmap.json`
- plotly_html: `sample_artifacts/ptable_heatmap.html`
