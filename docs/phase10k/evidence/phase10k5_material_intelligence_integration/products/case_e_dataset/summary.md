...
- Dataset: `dataset_phase10k5_classification`
- Profile: `profile_dataset_phase10k5_classification_v2` (contract 2.0)
- Samples: 4
- Structures: 0
- Formula coverage: READY
- Material properties: 0
- Comparison: NOT_REQUESTED (none)
