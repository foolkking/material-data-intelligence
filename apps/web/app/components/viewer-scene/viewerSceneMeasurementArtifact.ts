...
import type { PeriodicSiteRef, ValidatedRenderScene } from "./viewerSceneRendererTypes";
...
export function buildViewerMeasurementArtifact(scene: ValidatedRenderScene, coordinateMode: PeriodicMeasurementMode, refs: readonly PeriodicSiteRef[], result: ViewerMeasurementResult): ViewerMeasurementArtifact {
